...
function fw_ext_integrations_get_gallery_images( $post_id = 0 ) {
 ...
 */
function fw_ext_integrations_get_listing_categories( $term_ids ) {
	...
	$ext_integrations_settings = fw()->extensions->get( 'integrations' )->get_settings();
	$taxonomy = $ext_integrations_settings['taxonomy_name'];
 ...
 * @return array
 */
function fw_ext_integrations_get_sort_classes( array $items, array $categories, $prefix = 'category_' ) {
